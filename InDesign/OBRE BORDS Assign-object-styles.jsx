...
var styleMapping = {
    // Text frames
    "Agent1Info":     ["Text", "AlignCenter"],
    "Agent2Info":     ["Text", "AlignCenter"],
    "AgentInfoNHS":  ["Text", "AgentInfoNHS2col"],
    "Bullet":         ["Text", "AlignTop"],
    "Copy":           ["Text", "AlignTop"],
    "Overlay":        ["Text", "Overlay"],
    "Rooms":          ["Text", "Rooms2Col"],
    "Stylez":         ["Text", "AlignTop"],
    "URL":            ["Text", "AlignBottom"],

    // Image frames
    "AHS1":           ["Graphic", "FitToFrame"],
    "AHS2":           ["Graphic", "FitToFrame"],
    "Pic1":           ["Graphic", "AutoClip"],
    "Pic2":           ["Graphic", "AutoClip"],
    "Pic3":           ["Graphic", "AutoClip"],
    "bgForest":       ["Graphic", "bgForest_SPOT_LAB"],
    "bgLinen":        ["Graphic", "bgLinen_SPOT_LAB"],
    "CropMarks":      ["Graphic", "FitToFrame"],
    "Logo":           ["Graphic", "FitToFrame"],
    "QR1":            ["Graphic", "FitToFrame"]
};
