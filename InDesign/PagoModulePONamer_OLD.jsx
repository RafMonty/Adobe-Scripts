...
(function () {
    ...
    // Convert document ruler units → mm (unit-agnostic)
    ...
    var pageCodeInput = pageRow.add("edittext", undefined, "FP");
    ...
    // Default rows — common ad sizes, user can edit
    var defaults = [
        { on:true,  code:"FP", w:"210",   h:"297"   },
        { on:true,  code:"HP", w:"210",   h:"148.5" },
        { on:true,  code:"QP", w:"105",   h:"148.5" },
        { on:true,  code:"EP", w:"70",    h:"99"    },
        { on:false, code:"",   w:"",      h:""      },
        { on:false, code:"",   w:"",      h:""      },
        { on:false, code:"",   w:"",      h:""      },
        { on:false, code:"",   w:"",      h:""      }
    ...
    for (var r = 0; r < defaults.length; r++) {
        ...
        var code = row.add("edittext", undefined, d.code);
        code.preferredSize.width = 55;
        var wIn  = row.add("edittext", undefined, d.w);
        wIn.preferredSize.width  = 85;
        var hIn  = row.add("edittext", undefined, d.h);
