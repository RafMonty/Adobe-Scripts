 ...
 *    in the selected text frame. Each style name is placed on a new line 
 *    and has the corresponding paragraph style applied to it.
 *
 * Usage:
 *    1. Open an InDesign document.
 *    2. Select a single text frame where the style names should be inserted.
 *    3. Run this script.
 *
 * Notes:
...
(function () {
    ...
    // Insert each style name and apply the style
    for (var j = 0; j < validStyles.length; j++) {
        insertionPoint.contents = validStyles[j].name;
